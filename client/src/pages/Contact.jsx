        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            <a
              ...
              className="block"
            >
              <div className="flex items-start gap-4 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md hover:scale-[1.02] transition cursor-pointer">
          ...
          {/* Right: Contact Form */}
          <div className="bg-white dark:bg-slate-900 p-8 pt-4 rounded-xl shadow-lg">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded bg-gray-100 dark:bg-slate-700 dark:text-white border border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" // Added focus styles
              ...
              <textarea
                ...
                onChange={handleChange} // Handle changes
                className="w-full px-4 py-2 rounded bg-gray-100 dark:bg-slate-700 dark:text-white resize-none border border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" // Added focus styles
                disabled={loading} // Disable when loading
              ></textarea>
              <button
                type="submit"
